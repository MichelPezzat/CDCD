...
class VQVAE(nn.Module):
    def __init__(self, input_shape=(0,1), levels=3, downs_t=(3,2,2), strides_t=(2,2,2),
                 emb_width=64, l_bins=2048, mu=0.99, commit=0.02, spectral=0.0, multispectral=1.0,
                 multipliers=(2,1,1), use_bottleneck=True, width=32, depth=4, m_conv=1.0, dilation_growth_rate=3, dilation_cycle=None, reverse_decoder_dilation=True):
        super().__init__()
        ...
        def _block_kwargs(level):
            block_kwargs = dict(width=32, depth=4, m_conv=1.0,
